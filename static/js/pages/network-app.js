...
console.log('[KR Network] Welcome to the KR Network! It\'s currently in beta.');
console.log('- currently London only -');
console.log('1. You can explore the network by clicking any node.');
console.log('2. Check on "Collaborations" in the "COLLAB" tab - top right corner.');
...
async function initNetwork() {
  ...
  console.log('[index.html / network-app] Firestore: pulling network data...');
  allUsers = await window.networkFirebaseUtils.fetchAllUsers();
  console.log('[index.html / network-app] Firestore: loaded network data', allUsers.length, 'users');
