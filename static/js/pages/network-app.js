...
window.addEventListener('load', async () => {
  debugLoad('network_app_window_load_handler_start', {
    readyState: document.readyState,
    hasHideFn: typeof window.hideNetworkLoadingScreen === 'function'
  });
  console.log('[window.load] Starting: initNetwork then loadUserNotifications');
  await initNetwork();
  debugLoad('network_app_window_load_after_initNetwork', {
    allUsersCount: allUsers.length,
  ...
  console.log('[window.load] Calling loadUserNotifications (allUsers length:', allUsers.length, ')');
  await loadUserNotifications();
  debugLoad('network_app_window_load_after_notifications');
  ...
  if (linkFromUrl && allUsers.length > 0) {
    ...
    if (targetUser) {
      debugLoad('network_app_window_load_deeplink_target_found', {
        email: targetUser.email
      });
      ...
      if (targetNodeDatum) {
        debugLoad('network_app_window_load_deeplink_node_found', {
        ...
        debugLoad('network_app_window_load_deeplink_node_missing', {
          email: targetUser.email
        });
      ...
      debugLoad('network_app_window_load_deeplink_user_missing', {
        linkFromUrl
      });
  ...
  debugLoad('network_app_window_load_handler_complete', {
    activeClickedNodeId,
    currentProfileIdInUrl
  });
