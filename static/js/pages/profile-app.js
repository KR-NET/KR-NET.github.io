...
[blockTitleInput, blockDescInput, blockLinkInput, blockImgInput].filter(Boolean).forEach(input => {
...
function createCarouselSlideField(slide, idx) {
  ...
  div.innerHTML = `
    ...
    <div class='carousel-slide-details' style='display: ${detailsVisible};'>
      ...
      <input type='text' placeholder='Slide Title' value='${escapeCollabHtml(slide.title || '')}' class='input-feild carousel-slide-title'>
      <p class="input-feild-title-text" style="margin-top: 10px;">Description:</p>
      <input type='text' placeholder='Slide Description' value='${escapeCollabHtml(slide.desc || '')}' class='input-feild carousel-slide-desc'>
